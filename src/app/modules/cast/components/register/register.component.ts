...
export class RegisterComponent {
  ...
  constructor(private router: Router, private fb: FormBuilder, private responsiblesService: ResponsiblesService, private activatedRoute: ActivatedRoute, private castsService: CastsService) {
